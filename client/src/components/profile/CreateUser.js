...
function CreateUser({ handleLogout, role }) {
  ...
  return (
    <>
      <Sidebar handleLogout={handleLogout} role={role} username={localStorage.getItem('username')} />
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="d-flex">
                      <div
                        className="available-roles border p-3 me-3"
                      ...
                      <div
                        className="selected-roles border p-3"
