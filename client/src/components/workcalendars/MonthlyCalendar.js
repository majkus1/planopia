	...
	return (
		<div className='row'>
			<div className='col-xl-9'>
				<h3>Kalendarz pracy</h3>
				<hr />
				<label style={{ marginLeft: '10px', marginBottom: '20px', marginTop: '15px', marginBottom: '35px' }}>
					<input
						type='checkbox'
						checked={isConfirmed}
						onChange={toggleConfirmationStatus}
						style={{ marginRight: '10px', transform: 'scale(2)', cursor: 'pointer' }}
					/>
					Potwierdź kalendarz (Gdy uzupełnisz wszystkie godziny pracy, nieobecności w danym miesiącu)
				</label>
			...
			<div className='col-xl-3 resume-month-work'>
				<h3>Podsumowanie dla wybranego miesiąca:</h3>
			...
			<Modal
				...
				<h2 style={{ marginBottom: '20px' }}>Dodaj godziny pracy lub nieobecność</h2>
				<hr />
				<form onSubmit={handleSubmit} style={{ marginTop: '30px' }}>
					<label>
						...
						<input
							...
							style={{ minWidth: '130px', marginBottom: '20px', marginLeft: '5px' }}
						/>
					</label>
					<br />
					<label>
					...
					<br />
					{errorMessage && ( // Wyświetl komunikat błędu tylko jeśli istnieje
